...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText idText = (EditText)findViewById(R.id.et_id);
        EditText passwordText = (EditText)findViewById(R.id.et_pass);
        ...
        sellBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(),SellScanActivity.class);
    ...
    class BackgroundTask extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            target = "http://stock5424.dothome.co.kr/Table.php";
        }
